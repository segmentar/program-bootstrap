...
namespace Core
{
    ...
    {
        internal Tuple<String, String> CurrentTuple__FILE_FOLDER()
        {
            ...
            var result = new Tuple<String, String>(path_FILE_filename_with_extension__CURRENT, path_DIRECTORY_full_name__CURRENT);
